...
define('SECRET_SALT','53d80fc77bfe3776011892391bf1cc64');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@cybervolunteer.site');
...
define('DBNAME','cybervolunteer_4');
define('DBUSER','cybervolunteer_4');
define('DBPASS','S)pi]4D3h8');
